...
class PacketTunnelProvider: NEPacketTunnelProvider {
    ...
    private lazy var adapter: WireGuardAdapter = {
        return WireGuardAdapter(with: <#T##NEPacketTunnelProvider#>, logHandler: <#T##WireGuardAdapter.LogHandler##WireGuardAdapter.LogHandler##(WireGuardLogLevel, String) -> Void#>)}()
